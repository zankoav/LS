    ...
    <div class="header-mobile__navigation">
        <div class="header-mobile__navigation-top">
            ...
            <div class="header-mobile__close">
                <img class="header__close-icon" width="24" height="24" src="/wp-content/themes/LS/frontend/build/img/d64287053581ba847a5d.svg" alt="Close" />
            </div>
        </div>
...
<div class="page404-mobile">
    <h1 class="page404-mobile__title">Страница не найдена</h1>
</div>
