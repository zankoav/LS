<header class="header-mobile">
    ...
    <div class="header-mobile__navigation">
        ...
        <div class="header-mobile__navigation-bottom">
            <nav class="header-mobile__navigation-bottom-menu">
...
<div class="pt-128">
    <section class="welcome-mobile">
        <h1 class="welcome-mobile__title mb-24">Разработка одностраничного сайта</h1>
        <p class="welcome-mobile__description mb-32">
            Мы предлагаем разработку одностраничного сайта любой сложности по низким ценам с
            гарантией технической поддержки в течении года
        </p>
        <div class="welcome-mobile__button mb-32">
            <a class="button" href="#pricing">Узнать стоимость</a>
        </div>
        <div class="welcome-mobile__image">
            <img class="welcome-mobile__icon" src="/wp-content/themes/LS/frontend/build/img/47687c19c1ffb092aa4f.svg" alt="Разработка одностраничного сайта" />
        </div>
    </section>
</div>
<section class="products-mobile pt-88" id="products">
    <h2 class="products-mobile__title mb-32">Одностраничный сайт</h2>
    <div class="mb-24">
        <div class="product-mobile">
            <img class="product-mobile__icon mb-40" src="/wp-content/themes/LS/frontend/build/img/625b2e3fe0bf677fa77f.svg" alt="С НУЛЯ" />
            <h3 class="product-mobile__title mb-16">С НУЛЯ</h3>
            <p class="product-mobile__description mb-32">
                Разработка сайта на основе информации о Вашем бизнесе
            </p>
            <a class="button button_gray" href="#pricing" data-type="primary">Узнать стоимость</a>
        </div>
    </div>
    <div class="product-mobile product-mobile_dark-blue">
        <img class="product-mobile__icon mb-40" src="/wp-content/themes/LS/frontend/build/img/683cfd096ddb4e051cc2.svg" alt="По Вашему дизайну" />
        <h3 class="product-mobile__title mb-16">По Вашему дизайну</h3>
        <p class="product-mobile__description mb-32">
            Разработка сайта на основе Вашего дизайна
        </p>
        <a class="button button_gray" href="#pricing" data-type="secondary">Узнать стоимость</a>
    </div>
</section>
<section class="ordering-mobile pt-88" id="ordering">
    <h2 class="ordering-mobile__title mb-32">Порядок сотрудничества</h2>
    <div class="mb-24">
...
<section class="pricing-mobile pt-88" id="pricing">
    <h2 class="pricing-mobile__title mb-32">Стоимость сайта</h2>
    <div class="pricing-mobile__card pricing-mobile__card_active pricing-mobile__card_main">
        <div class="pricing-mobile__header">
            <div class="pricing-mobile__header-item pricing-mobile__header-item_active pricing-mobile__header-item_primary">
                С нуля
            </div>
            <div class="pricing-mobile__header-item pricing-mobile__header-item_secondary">
                ПО ВАШЕМУ ДИЗАЙНУ
            </div>
        </div>
        <div class="pricing-mobile__content pricing-mobile__content_active pricing-mobile__content_primary mb-48">
            <div class="mb-32">
                <div class="input-field" data-required="yes">
                    <input class="input-field__input" name="phone" placeholder="Телефон *" />
                    <p class="input-field__error-message">Пожалуйста, заполните поле</p>
                </div>
            </div>
            <div class="mb-32">
                <div class="input-field" data-required="yes">
                    <input class="input-field__input" name="opponent" placeholder="Ссылка на сайт вашего конкурента *" />
                    <p class="input-field__error-message">Пожалуйста, заполните поле</p>
                </div>
            </div>
            <div class="textarea-field">
                <textarea class="textarea-field__textarea" name="comments" placeholder="Дополнительная информация" rows="5"></textarea>
            </div>
        </div>
        <div class="pricing-mobile__content pricing-mobile__content_secondary mb-48">
            <div class="mb-32">
                <div class="input-field" data-required="yes">
                    <input class="input-field__input" name="phone" placeholder="Телефон *" />
                    <p class="input-field__error-message">Пожалуйста, заполните поле</p>
            ...
            <div class="mb-32">
                <div class="input-field" data-required="yes">
                    <input class="input-field__input" name="prototip" placeholder="Ссылка на прототип в figma *" />
                    <p class="input-field__error-message">Пожалуйста, заполните поле</p>
                </div>
            </div>
            <div class="textarea-field">
        ...
        <div class="pricing-mobile__content-footer">
            <div class="pricing-mobile__content-footer-text">
    ...
    <div class="pricing-mobile__card pricing-mobile__card_thank-you">
        <div class="pricing-mobile__card-title mb-16">Поздравляем!</div>
